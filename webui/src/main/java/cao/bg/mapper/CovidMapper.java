...
public interface CovidMapper {
    ...
    @Select("select name_GP as name, `cg_GP` as `采购`, `xb_GP` as `下拨`, `jz_GP` as `捐赠`, `xh_GP` as `消耗`, `xq_GP` as `需求`, `kc_GP` as `库存` from covid19_wz")
